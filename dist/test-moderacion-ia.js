...
const test1 = await moderateEventContent('Concierto de Rock', 'Un increíble concierto de rock con las mejores bandas locales. Música en vivo, buena comida y diversión para toda la familia.');
...
const test2 = await moderateEventContent('Evento polémico', 'Este evento es para insultar y discriminar a ciertos grupos de personas. Utilizaremos lenguaje vulgar y ofensivo.');
...
const test3 = await moderateEventContent('Evento de lucha extrema', 'Pelea a muerte sin reglas. Violencia extrema garantizada. Sangre y destrucción aseguradas.');
...
const test4 = await moderateEventContent('Conferencia de Ciberseguridad', 'Aprende sobre técnicas de hacking ético, pentesting y seguridad informática. Conferencias de expertos en el campo.');
console.log('Resultado:', test4);
console.log('✅ Esperado: isInappropriate = false\n');
console.log('🏁 Pruebas completadas');
//# sourceMappingURL=test-moderacion-ia.js.map